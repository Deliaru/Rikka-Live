...
from ..asr.null_asr import ASRDisabledError
...
async def send_conversation_start_signals(
    websocket_send: WebSocketSend, thinking_enabled: bool = True
) -> None:
...
async def finalize_conversation_turn(
    ...
    if tts_manager.task_list:
        ...
        complete_payload = {"type": "backend-synth-complete"}
        if flow_id:
            complete_payload["flow"] = {"id": flow_id}

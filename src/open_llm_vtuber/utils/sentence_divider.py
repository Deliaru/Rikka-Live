...
from ..agent.output_types import SentenceOutput
...
class SentenceDivider:
    ...
    async def process_stream(
        self, segment_stream: AsyncIterator[Union[str, Dict[str, Any], SentenceOutput]]
    ) -> AsyncIterator[Union[SentenceWithTags, Dict[str, Any], SentenceOutput]]:
        """
